				...
				<div class="d-flex justify-content-end">
					...
					<div class=" dropdown " id="completed_email_comment">
						<button class="btn p-0 dropdown-toggle"
							id="completed_email_comment" data-toggle="dropdown"
						...
						<div
							...
							aria-labelledby="completed_email_comment" style="right: -67px;">
					...
					<div class=" dropdown">
						...
						<div
							...
							aria-labelledby="completed_email_reply" style="right: -18px;">
