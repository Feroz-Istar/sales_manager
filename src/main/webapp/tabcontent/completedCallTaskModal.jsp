			...
			<div class="col-3 p-0">
				<div class="d-flex justify-content-end">
					...
					<div class=" dropdown" id="completed_call_comment">
						<button class="btn p-0 dropdown-toggle" id="completed_call_comment"
						...
						<div
							...
							aria-labelledby="completed_call_comment">
							<div class="tab-content border-0" id="myTabContent">
								<div class="tab-pane fade pt-25 pl-20 pr-20   active show"
									id="completed_call_comment" role="tabpanel"
									aria-labelledby="completed_call_comment-tab"
