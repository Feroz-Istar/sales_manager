...
<div class="row h-100 m-0">
								<div class="col-md-11 p-0">
									<div class="row pt-15 pl-45 pr-45 justify-content-between m-0">
										<div class="col-9 p-0">
						...
						<div style="background-image: url(<%=baseURL%>assets/image/heart.svg); height: 24px; width: 24px;" class="mr-15 fav"></div>
												...
												<div class=" dropdown " id="completed_user_comment">
													<button class="btn p-0 dropdown-toggle"
														id="completed_user_comment" data-toggle="dropdown"
													...
													<div
														...
														aria-labelledby="completed_user_comment" style="right: -67px;">
															...
															<div class="card-footer p-0 border-top-0  bg-white">
																<div class="row d-flex justify-content-end m-0">
																	<button type="button"
																		...
																		id="completed_user_comment_submit">Submit</button>
																</div>
															</div>
														</div>
													</div>
												...
												<div class=" dropdown">
													<button class="btn  p-0 dropdown-toggle" id="completed_user_reply"
													...
													<div
														...
														<div style="height: 370px; overflow-x: hidden; overflow-y: auto;">
															...
															<div class="d-flex align-items-center pb-10 ">
																<input class="istar-checkbox agentcheckbox " data-id="0"
																	id="completed_user_reply-checkbox<%=i%>" type="checkbox">
																<label class="istar-checkbox-style"
																	for="completed_user_reply-checkbox<%=i%>"></label> <img
																	alt="user-img"
														...
														<button type="button"
															...
															id="completed_user_reply_submit"  data-toggle="modal" data-target="#shareTaskModal">Submit</button>
...
$('#completed_user_reply_submit').click(function(){
	$('#completed_user_reply').dropdown('hide');
  ...
  $('#completed_user_comment').on('show.bs.dropdown', function () {
	  $(".comment").addClass('active');
	});
 $('#completed_user_comment').on('hidden.bs.dropdown', function () {
  		$(".comment").removeClass('active');
	});
 $('#completed_user_reply').on('show.bs.dropdown', function () {
	  $(".share").addClass('active');
	});
 $('#completed_user_reply').on('hidden.bs.dropdown', function () {
  		$(".share").removeClass('active');
	});
</script>
