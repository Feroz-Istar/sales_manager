        ...
        <option value="GA">Georgia</option>
									...
									<div class="row  pt-20 m-0">
										...
										<div class="col-md-6 p-0 pl-7_5">
											...
											<div class="dropdown istar-dropdown">
												<button class="custom-modal-input w-100 pl-2 d-flex h-35" style="justify-content: space-between;" id="task_by" data-toggle="dropdown" aria-haspopup="true" data-display="static"
													aria-expanded="false">
