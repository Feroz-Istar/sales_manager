...
<%
	...
	String teamdata = IOUtils.toString(request.getReader());
	 Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").create();	
	 Team team = gson.fromJson(teamdata, Team.class);
%>


<div class="team-container active item cursor-pointer" onclick="window.location.href='<%=baseURL%>report/report.jsp#users'" style="padding: 30px;">
	<div class="row m-0 ">
		<div class="col-md-6 p-0 pb-20">
			<div class="p-0 m-0 font-weight-bold f-18 text-truncate team-name" title="team">
				<%=team.getName() %>&nbsp; - &nbsp;<span class="brown-grey f-16 font-weight-normal"><%=team.getUsers().size() %> users</span>
			</div>
		</div>
	...
	<div class="row m-0">
			...
			<div class="row m-0">
				<div class="col-md-4 p-0">
					<div class="font-weight-bold f-30">
						<i class="fas fa-dollar-sign light_gray"></i> <span class="theme_color achieved-value"> 50K</span>
					</div>
				</div>
				<div class="col-md-4 p-0">
		...
		<div class="col-md-6 p-0 pl-15">
			...
			<div class="strong-signal w-100 d-flex flex-wrap">
				<img src="<%=baseURL%>assets/image/introduction_signal.svg" class="pr-2 pb-2"> <img src="<%=baseURL%>assets/image/softSkill_signal.svg" class="pr-2 pb-2"> <img src="<%=baseURL%>assets/image/nxt_step_signal.svg" class="pr-2 pb-2"> <img src="<%=baseURL%>assets/image/solution_signal.svg" class="pr-2 pb-2"> <img
			...
			<div class="f-12 brownish-grey d-flex align-items-center  text-break font-weight-bold pt-20 pb-10">
				<div>WeaK</div>
				<i class="fal fa-info-circle soft-blue f-18 pl-5"></i>
			</div>
