...
%>
			...
			<div class="row grey-white-bg align-items-center theme_solid_border_bottom justify-content-between m-0 pl-40 pt-10 pb-10 pr-40	">
				<div class="col-md-6 col-12 d-flex align-items-center p-0">
					...
					<div class="display-1 black f-20 border-right-separation fw-500 pr-20">Accenture Consulting Inc.</div>
			...
			<div class="row bg-white m-0 ">
				...
				<div class="float-right col-md-1 p-0 z-9" id="calldropleft">
					<div class=" dropleft">
						<button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display: none" id="connected_call_task_content">Dropleft</button>
					...
					<ul class="list-group shadow d-flex flex-column h-100  taskpopup">
						...
						<li class="notesdropdown list-group-item p-0 py-3">
							<div class=" d-flex flex-column justify-content-center align-items-center minh-50 " data-dropdown_id="connected_call_task_content">
