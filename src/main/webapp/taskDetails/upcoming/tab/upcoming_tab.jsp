...
<div class="row align-items-center 	p-20 p-0 m-0">
		...
		<div class="col-md-4 p-0">
			<div class="d-flex flex-row align-items-center justify-content-end">
				<img src="<%=upcomingTask.getImage() %>" alt="task-icon" class="rounded-circle hw-30 task-icon" /> <img src="<%=baseURL%>assets/image/37.jpg" alt="task-image" data-toggle="tooltip"
