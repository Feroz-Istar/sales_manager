         ...
         <div class="col p-0">
            ...
            <div class="tab-content mytab-content p-0 pt-20"
               ...
               <div class="tab-pane fade show " id="completedcall_timeline" role="tabpanel" aria-labelledby="completedcall_timeline-tab">
                  <div class="card border-0 card-shadow-bottom" id="callTimeline_sub_tab_card">
                  </div>
                  <div class="row m-0 theme_dashed_border_bottom   pt-20 pb-20" id="">
                     ...
                     <div class="col-md-11 d-flex  p-0">
                        <div class="input-group date custom-calendar mr-10">
                           <input type="text" id="completedcallTimeline_datepicker" class="form-control  custom-dateselect" value="12-02-2012" placeholder="Calendar">
                           <div class="input-group-addon" onclick="showCompletedCallTimelineCalendar()">
                              <img src="<%=baseURL%>/assets/image/calendar.svg" alt="calendar" class="pr-1 hw-24">
                           </div>
                        </div>
                        <div class="istar-dropdown-task select_focus mr-10">
                           <button class="istar-dropdown-arrow dropdown-toggle" data-display="static" id="completedcallTimeline_persona" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           <span class="sr-only">Toggle Dropdown</span> <span id="completedcall_timeline_drop">All Persona</span> <img src="<%=baseURL%>assets/image/dropdown_right.svg" alt="call" class=" float-right">
                           </button>
                           <div class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="completedcalTimeline_persona" id="">
                              <button class="dropdown-item" type="button" onclick="completedcall_timeline_persona(this)" data-id="Persona 1">Persona 1</button>
                              <button class="dropdown-item" type="button" onclick="completedcall_timeline_persona(this)" data-id="Persona 2">Persona 2</button>
                           </div>
                        </div>
                        <div class="istar-dropdown-task select_focus mr-10">
                           <button class="istar-dropdown-arrow dropdown-toggle" data-display="static" id="completedcallTimeline_success" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           <span class="sr-only">Toggle Dropdown</span><span id="completedcall_timeline_success_drop">Filter by Success</span> <img src="<%=baseURL%>assets/image/dropdown_right.svg" alt="call"
                              class=" float-right">
                           </button>
                           <div class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="completedcall_timeline_success">
                              <button class="dropdown-item" type="button" onclick="completedcall_timeline_success(this)" data-id="Lead 1">Lead 1</button>
                              <button class="dropdown-item" type="button" onclick="completedcall_timeline_success(this) " data-id="Lead 2">Lead 2</button>
                           </div>
                        </div>
                        <div class="istar-dropdown-task dropdown select_focus" id="">
                           <button class="istar-dropdown-arrow " data-display="static" id="completedcallTimeline_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <div class="dropdown-menu filter-menu dropdown-menu-right istar-dropdown-task-menu  dropdown-menu-lg-right position-absolute px-4" aria-labelledby="completedcallTimeline_dropdown"
                              style="width: 350px;">
                              ...
                              <div class="tab-content" id="completedcall_timelineTabContent">
                                 <div class="tab-pane fade show active px-4 py-3" id="completedcall_timeline_individual" role="tabpanel" aria-labelledby="completedcall_timeline_individual-tab">
                                    ...
                                    <div class="completedCallTimeline-agent-list mb-2" style="overflow-x: hidden; overflow-y: auto;"></div>
                                 </div>
                                 <div class="tab-pane fade px-4 py-3" id="completedcall_timeline_team" role="tabpanel" aria-labelledby="completedcall_timeline_team-tab">
                                    ...
                                    <div class="completedCallTimeline-team-list mb-2" style="overflow-x: hidden; overflow-y: auto;"></div>
                                 </div>
                              </div>
                              <div class="w-100 text-center">
                                 <button class="btn  rounded-0 theme_bg text-white f-14 font-weight-bold  mb-3 text-center px-3" style="min-width: 200px;" id="completedcall_timeline_team_submit">Submit</button>
                              </div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row cream_white m-0 theme_solid_border_bottom justify-content-between align-items-center pl-40 pr-40 pt-10 pb-10" id="completedcallTimeline_filter_selections">
                     <div class="col-md-10 d-flex p-0 filters-inside-selection"></div>
                     <div class="col-md-2 text-right p-0">
                        <button type="submit" class="btn theme_color f-14 font-weight-bold p-0" data-type="completedCallTimeline" id="completedCallTimeline_reset" onclick="resetFilters(this)">Reset</button>
                     </div>
                  </div>
                  <span id="completedcall_timeline_section"></span>
               </div>
               <div class="tab-pane fade show " id="completedcall_adherence" role="tabpanel" aria-labelledby="completedcall_adherence-tab">
                  ...
                  <div class="row m-0 theme_dashed_border_bottom  pt-20 pb-20" id="completedcall_adherence_filter">
                     ...
                     <div class="col-md-11 d-flex justify-content-center p-0">
                        ...
                        <div class="istar-dropdown-task dropdown select_focus" id="">
                           <button class="istar-dropdown-arrow " data-display="static" id="completedcallAdherence_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           <span class="sr-only">Toggle Dropdown</span> All Agents <img src="<%=baseURL%>assets/image/dropdown_right.svg" alt="call" class=" float-right">
                           </button>
                           <div class="dropdown-menu filter-menu dropdown-menu-right istar-dropdown-task-menu  dropdown-menu-lg-right position-absolute px-4" aria-labelledby="completedcallAdherence_dropdown"
                              style="width: 350px;">
                              ...
                              <div class="tab-content" id="completedcall_adherenceTabContent">
                                 <div class="tab-pane fade show active px-4 py-3" id="completedcall_adherence_individual" role="tabpanel" aria-labelledby="completedcall_adherence_individual-tab">
                                    ...
                                    <div class="completedCallAdher-agent-list mb-2" style="overflow-x: hidden; overflow-y: auto;"></div>
                                 </div>
                                 <div class="tab-pane fade px-4 py-3" id="completedcall_adherence_team" role="tabpanel" aria-labelledby="completedcall_adherence_team-tab">
                                    ...
                                    <div class="completedCallAdher-team-list mb-2" style="overflow-x: hidden; overflow-y: auto;"></div>
                                 </div>
                              </div>
                              <div class="w-100 text-center">
