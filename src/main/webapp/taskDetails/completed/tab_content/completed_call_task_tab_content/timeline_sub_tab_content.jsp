...
%>
 <div class="card-body  p-0 card-shadow-bottom" id="completedcall_timeline_card">
                     ...
                     <div class="row m-0 theme_dashed_border_bottom   pt-20 pb-20" id="">
                        ...
                        <div class="col-md-11 d-flex  p-0">
                           <div class="input-group date custom-calendar mr-10">
                              <input type="text" id="completedcall_timeline_datepicker" class="form-control  custom-dateselect" value="12-02-2012" placeholder="Calendar">
                              <div class="input-group-addon" onclick="showCompletedCallCalendar()">
                                 <img src="<%=baseURL%>/assets/image/calendar.svg" alt="calendar" class="pr-1 hw-24">
                              </div>
                           </div>
                           <div class="istar-dropdown-task select_focus mr-10">
                              <button class="istar-dropdown-arrow dropdown-toggle" data-display="static" id="completedcall_timeline_persona" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              ...
                              <div class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="completedcall_timeline_persona" id="">
                                 <button class="dropdown-item" type="button" onclick="completedcallTask_Timline_dropdown(this)">Persona 1</button>
                                 <button class="dropdown-item" type="button" onclick="completedcallTask_Timline_dropdown(this)">Persona 2</button>
                              </div>
                           </div>
                           <div class="istar-dropdown-task select_focus mr-10">
                              <button class="istar-dropdown-arrow dropdown-toggle" data-display="static" id="completedcall_timeline_success" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              ...
                              <div class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="completedcall_timeline_success">
                                 <button class="dropdown-item" type="button" onclick="completedcall_timeline_success(this)">Lead 1</button>
                                 <button class="dropdown-item" type="button" onclick="completedcall_timeline_success(this)">Lead 2</button>
                              </div>
                           </div>
                           <div class="istar-dropdown-task dropdown select_focus" id="">
                              <button class="istar-dropdown-arrow " data-display="static" id="completedcall_timeline_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <div class="tab-content" id="completedcall_timelineTabContent">
                                    <div class="tab-pane fade show active px-4 py-3" id="completedcall_timeline_individual" role="tabpanel" aria-labelledby="completedcall_timeline_individual-tab">
                                       ...
                                       <div class="agent-team-list mb-2" style="overflow-x: hidden; overflow-y: auto;">
                                          ...
                                          <div class="d-flex align-items-center pt-3">
                                             <input class="istar-checkbox completedcall_timelineagentcheckbox" data-id="<%=i %>" id="completedcall_timeline_associate-checkbox<%=i %>" type="checkbox"> <label
                                                class="istar-checkbox-style" for="completedcall_timeline_associate-checkbox<%=i %>"></label> <img alt="Lead Image" title="Lead Name" src="<%=baseURL%>/assets/image/11.png"
                                    ...
                                    <div class="tab-pane fade px-4 py-3" id="completedcall_timeline_team" role="tabpanel" aria-labelledby="completedcall_timeline_team-tab">
                                       ...
                                       <div class="agent-team-list mb-2" style="overflow-x: hidden; overflow-y: auto;">
                                          <%for(int j=0; j<20;j++){ %>
                                          <div class="d-flex align-items-center pt-3">
                                             <input class="istar-checkbox completedcall_timelineteamcheckbox" data-id="<%=j %>" id="completedcall_timeline_team-checkbox<%=j %>" type="checkbox"> <label class="istar-checkbox-style"
                                                for="completedcall_timeline_team-checkbox<%=j%>"></label>
