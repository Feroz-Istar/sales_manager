      ...
      <div class="row m-0 pl-45 pr-45 pt-20 ">
         <div class="col p-0">
            ...
            <div class="tab-content mytab-content p-0 pt-20"
               id="leadTabContent">
               <div class="tab-pane fade show active" id="leadwhatswrong"
               ...
               <div class="tab-pane fade show " id="leadwhatsright" role="tabpanel"
               ...
               <div class="tab-pane fade show " id="lead_timeline" role="tabpanel" aria-labelledby="lead_timeline-tab">
                  <div class="card-body  p-0 card-shadow-bottom" id="lead_timeline_card">
                  ...
                  <div class="row m-0 theme_dashed_border_bottom   pt-20 pb-20" id="">
                     ...
                     <div class="col-md-11 d-flex  p-0">
                        <div class="input-group date custom-calendar mr-10">
                           <input type="text" id="lead_timeline_datepicker" class="form-control  custom-dateselect" value="12-02-2012" placeholder="Calendar">
                        ...
                        <div class="istar-dropdown-task select_focus mr-10">
                           <button class="istar-dropdown-arrow dropdown-toggle" data-display="static" id="lead_timeline_persona" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <div class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="lead_timeline_persona" id="">
                              <button class="dropdown-item" type="button" onclick="lead_timeline_persona(this)">Persona 1</button>
                              <button class="dropdown-item" type="button" onclick="lead_timeline_persona(this)">Persona 2</button>
                           </div>
                        </div>
                        <div class="istar-dropdown-task select_focus mr-10">
                           <button class="istar-dropdown-arrow dropdown-toggle" data-display="static" id="lead_timeline_success" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <div class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="lead_timeline_success">
                              <button class="dropdown-item" type="button" onclick="lead_timeline_success(this)">Lead 1</button>
                              <button class="dropdown-item" type="button" onclick="lead_timeline_success(this)">Lead 2</button>
                           </div>
                        </div>
                        <div class="istar-dropdown-task dropdown select_focus" id="">
                           <button class="istar-dropdown-arrow " data-display="static" id="lead_timeline_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           ...
                           <div class="dropdown-menu filter-menu dropdown-menu-right istar-dropdown-task-menu  dropdown-menu-lg-right position-absolute px-4" aria-labelledby="lead_timeline_dropdown"
                              style="width: 350px;">
                              ...
                              <div class="tab-content" id="lead_timelineTabContent">
                                 <div class="tab-pane fade show active px-4 py-3" id="lead_timeline_individual" role="tabpanel" aria-labelledby="lead_timeline_individual-tab">
                                    ...
                                    <div class="agent-team-list mb-2" style="overflow-x: hidden; overflow-y: auto;">
                                       ...
                                       <div class="d-flex align-items-center pt-3">
                                          <input class="istar-checkbox lead_timelineagentcheckbox" data-id="<%=i %>" id="lead_timeline_associate-checkbox<%=i %>" type="checkbox"> <label
                                             class="istar-checkbox-style" for="lead_timeline_associate-checkbox<%=i %>"></label> <img alt="Lead Image" title="Lead Name" src="<%=baseURL%>/assets/image/11.png"
                                             class="rounded-circle ml-3 mr-2 hw-40">
                                          <div>
                                 ...
                                 <div class="tab-pane fade px-4 py-3" id="lead_timeline_team" role="tabpanel" aria-labelledby="lead_timeline_team-tab">
                                    ...
                                    <div class="agent-team-list mb-2" style="overflow-x: hidden; overflow-y: auto;">
                                       <%for(int j=0; j<20;j++){ %>
                                       <div class="d-flex align-items-center pt-3">
                                          <input class="istar-checkbox lead_timelineteamcheckbox" data-id="<%=j %>" id="lead_timeline_team-checkbox<%=j %>" type="checkbox"> <label class="istar-checkbox-style"
                                             for="lead_timeline_team-checkbox<%=j%>"></label>
                              ...
                              <div class="w-100 text-center">
                                 <button class="btn  rounded-0 theme_bg text-white f-14 font-weight-bold  mb-3 text-center px-3" style="min-width: 200px;" id="lead_timeline_team_submit">Submit</button>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="tab-pane fade show " id="lead_adherence" role="tabpanel" aria-labelledby="lead_adherence-tab">
