								...
								<div class="d-flex flex-row align-items-center mb-2 ">
									<div class="font-weight-bold f-14 bblack">Meeting with Sales Team</div> 
										<div class=" ml-auto istar-dropdown dropleft f-12 brown-grey">
											...
											<div class="dropdown-menu dropdown-menu-right istar-dropdown-menu" aria-labelledby="dropdownMenuButton">
			...
			<div class="col-md-3 p-0 pl-md-3 pr-md-3">
				...
				<div class="card mb-3 shadow" style="min-height: 313px;">
					<div class="card-body">
						...
						<div class="d-flex align-items-center mb-2">
							...
							<div class=" bd-highlight">
								<div class="img-wrapper position-relative">
																	<img class="hw-66 rounded-circle img-responsive" src="<%=baseURL%>assets/image/layer.png" />
									<div class="img-overlay" style="position: absolute;left: -19px;top: 28%;">
								<button class="hw-30 rounded-circle tea border-0" style="z-index:1;    border: 2px solid white !important;"><i class="fas fa-phone-alt  text-white f-12"></i></button>
									</div>
								</div>
						...
						<div class="d-flex">
						<button type="button" class="btn join_btn f-12 mr-2">JOIN NOW</button>
				...
				<div class="card mb-3 shadow" style="min-height: 179px;">
					<div class="card-body mr-md-3">
						...
						<div class="row align-items-center mb-3">
							...
							<p class="card-text greyish-brown f-14" >Hello Sir, The customer is asking about discount, please tell me….</p>
							</div>
							<div class="col-md-3 col-6">
								<img class="hw-60 " alt="user" src="<%=baseURL%>assets/image/11.png">
							
							</div>
						 </div>
						
						
						<div><button type="button" class="btn join_btn f-12 mr-2">CHAT NOW</button></div>
					</div>
