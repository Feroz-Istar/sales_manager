	...
	<div class="container-fluid salesken_container">
		...
		<div class="row ">
			...
			<div class="col-md-3 pr-0 left_container pl-0 bg-white">
				...
				<ul class="saleken nav nav-tabs f-16  pb-0 pl-20 pt-30" id="myTab"
					role="tablist" style="background: #f9f9f9">
					<li class="nav-item"><a
						class="nav-link active border-istar-left-0 " id="home-tab"
						data-toggle="tab" href="#home" role="tab" aria-controls="home"
						aria-selected="true">To - Do List</a></li>
				...
				<div class="tab-content " id="myTabContent"
					...
					<div class="tab-pane fade show active " id="home" role="tabpanel"
						...
						<div class="task-item-container bg-white  pl-20 pt-20 pr-20 pb-40">
							...
							<div class="d-flex flex-row align-items-center  istar-dropdown pb-10">
								...
								<div class="istar-dropdown-task border-0">
									...
									<div
										...
										<button class="dropdown-item  f-14 fw-500" type="button"
											id="schedule_task" onclick="scheduleTask()">Schedule
											Task</button>
							...
							<div class="no-event">
								...
								<div class="fw-500 f-16 greyish-brown mb-2 text-center">Track
									your tasks</div>
								<div class="fw-500 f-12 brownish-grey  mx-4 px-4 text-center">Lorem
					...
					<div class="tab-pane fade bg-white" id="profile"
						...
						<div class="no-notes text-center cursor-pointer"
							onclick="opennotes()">
							<div class="w-100 mt-4 pt-4">
								<img src="<%=baseURL%>assets/image/make_notes.svg"
									alt="no-notes" srcset="" class="mr-2 mb-4">
							</div>
							<div class="fw-500 f-16 greyish-brown mt-2 mb-2">Keep your
								notes</div>
							<div class="fw-500 f-12 brownish-grey  mx-4 px-4">Lorem
								Ipsum is simply dummy text of the printing and typesetting
								industry.</div>
						</div>
				...
				<div class="third_main_container">
					...
					<div class="card  rounded-0 shadow mb-10">
						<div class="card-body ongoingtaskcard cursor-pointer p-0 p-20">
							...
							<div class="f-16 brownish-grey text-truncate" title="Accenture">Robert
								Wolken</div>
							...
							<div class="d-flex align-items-center pt-20">
								<div class="mr-auto  ">
									<div class="d-flex flex-column">
										...
										<div class="brownish-grey f-16 text-truncate"
											title="Accenture">Marry Vasquez</div>
									</div>
					...
					<div class="card rounded-0 shadow mb-10">
						<div class="card-body p-0 p-20">
							<h6 class="card-subtitle m-0 brown-grey f-12 pb-10 fw-300">June
								12, 2019</h6>
							<p class="card-text greyish-brown f-14 text-truncate mb-0"
								title="Product Price in too expensive">Product Price in too
								expensive, and agents are not supportive and they are not
								providing information !</p>
							<div
								class="f-18 pt-20 greyish-brown text-truncate font-weight-bold"
								title="Martin Franklin">Martin Franklin</div>
							<div class="f-16 brownish-grey text-truncate"
								title="Infogen Consulting Pvt.">Infogen Consulting Pvt.
								Ltd</div>
							<div class="pt-25">
								<button type="button"
									class="btn small_button rounded-0 f-12 font-weight-bold resolvecardmodal"
									href="/modals/resolvetask.jsp">RESOLVE</button>
							</div>
						</div>
						<div class="card-footer cream_white p-0 pt-10 pb-10">
					...
					<div class="card mb-10 rounded-0 shadow">
						<div class="card-body p-0 p-20">
							...
							<div>
								<button type="button"
									class="btn join_btn  istar-btn-hover f-12 mr-2">CHAT
									NOW</button>
							</div>
						</div>
		...
		<div class="modal fade" id="createEventModalCenter" tabindex="-1"
			role="dialog" aria-labelledby="createEventModalCenterTitle"
			aria-hidden="true">
			...
			<div class="modal-dialog modal-lg modal-dialog-centered"
				...
				<div class="modal-content  rounded-0 ">
					<div class="modal-header pt-20 pb-20 pl-30 pr-30 shadow-bottom">
						<h5 class="modal-title greyish-brown f-18 font-weight-bold mb-0">Schedule
							Task</h5>
						<button type="button" class="close" data-dismiss="modal"
							aria-label="Close">
							<img src="<%=baseURL%>assets/image/close.svg" alt="taskicon"
											...
											<div
												...
												<button class="dropdown-item" type="button">
													<img src="<%=baseURL%>assets/image/emailtask.svg"
														alt="email" class="task-dropdown"> Email Task
												</button>
												<button class="dropdown-item" type="button">
					...
					<div class="modal-footer p-0 pt-30 pb-30 pr-30 pl-30">
						...
						<button type="button"
							class="btn big_button modal-submit-btn rounded-0 f-14 font-weight-bold"
							id="schedule">SCHEDULE</button>
			  ...
			  <div class="modal-dialog modal-dialog-centered modal-lg	" role="document">
			    ...
			    <div class="row justify-content-end m-0 pt-25 pr-25">
			      ...
			      <div class="modal-footer border-0 p-0 pl-30 pr-30 pb-30">
					...
					<button type="button" class="btn modal-submit-btn f-14 font-weight-bold"
