					...
					<div class="tab-pane fade" id="users" role="tabpanel"
						...
						<div class="row align-items-center  theme_solid_border_bottom  py-3 pl-4">
							...
							<div class="col-md-9 d-md-flex justify-content-end  ">
									...
									<div class="istar-dropdown-task select_focus mr-10">
									<button class="istar-dropdown-arrow dropdown-toggle"
										id="user_activity" data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">
										<span class="sr-only">Toggle Dropdown</span> Filter by
										Activities 
										<img src="<%=baseURL%>assets/image/dropdown_right.svg" alt="call"
									...
									<div
										class="dropdown-menu dropdown-menu-right istar-dropdown-task-menu" aria-labelledby="user_activity">
										<button class="dropdown-item" type="button">
											<img src="<%=baseURL%>assets/image/calltask.svg" alt="call"
												class="task-dropdown"> Call Task
										</button>
									...
									<div class="istar-dropdown-task dropdown dropleft" id="filterbutton">
										<button class="istar-dropdown-arrow "
										id="user_dropdown" data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">
										<span class="sr-only">Toggle Dropdown</span> Filter by User <img src="<%=baseURL%>assets/image/dropdown_right.svg" alt="call"
												class=" float-right">
										</button>
										
										 <div class="dropdown-menu filter-menu dropdown-menu-lg-right position-absolute px-4 " aria-labelledby="user_dropdown" style="width:350px">
												
												<ul class="nav nav-tabs nav-mytabs filtertabs pt-2" id="userTab" role="tablist">
												  <li class="nav-item">
												    <a class="nav-item nav-link active" id="user_individual-tab" data-toggle="tab" href="#user_individual" role="tab" aria-controls="user_individual" aria-selected="true">Individual</a>
												  </li>
												  <li class="nav-item">
												    <a class="nav-item nav-link" id="user_team-tab" data-toggle="tab" href="#user_team" role="tab" aria-controls="user_team" aria-selected="false">Team</a>
												  </li>
												 
												</ul>
												<div class="tab-content" id="userTab-tabContent">
												  <div class="tab-pane fade show active px-4 py-3" id="user_individual" role="tabpanel" aria-labelledby="user_individual-tab">
												  		<div class="input-group py-2">
															<input id="user_individual_search" class="form-control  custom-userborder brown-grey  removefocus f-14 search_height" type="search" placeholder="Search" style="border-right: none !important;">
															<div class="input-group-append">
																<button class="btn removefocus border_except_left search_height d-flex justify-content-center align-items-center" type="button" style="">
																	<i class="fa fa-search f-12 brown-grey"></i>
																</button>
									...
									<input class="istar-checkbox useragentcheckbox" data-id="<%=i %>" id="user_associate-checkbox<%=i %>" type="checkbox">
					                                        <label class="istar-checkbox-style" for="user_associate-checkbox<%=i %>"></label>
											<img alt="Agent Image" title="Agent Name" src ="<%=baseURL%>/assets/image/11.png" class="rounded-circle ml-3 mr-2 hw-40">
										  <div>
					                                        	<div class="f-14 font-weight-bold greyish-brown text-truncate" title="Robert Garcia">Robert Garcia</div>
					                                        	<div class="f-12  brownish-grey text-truncate" title="team">Team -02</div>
										...
										<%} %>
												  ...
												  <div class="tab-pane fade px-4 py-3" id="user_team" role="tabpanel" aria-labelledby="user_team-tab">
														...
														<%for(int j=0; j<20;j++){ %>
														<div class="d-flex align-items-center pt-3">
					                                        <input class="istar-checkbox userteamcheckbox" data-id="<%=j %>" id="user_team-checkbox<%=j %>" type="checkbox">
					                                        <label class="istar-checkbox-style" for="user_team-checkbox<%=j%>"></label>
					                                        <div class="f-12 ml-2 brownish-grey">Team -0<%=j%></div>
					                                    </div>
					                                    <%} %>
					                                    </div>
												 ...
												 <div class="w-100 text-center">
												 <button class="btn  rounded-0 theme_bg text-white f-14 font-weight-bold mb-3 text-center px-3" style="min-width:200px;" id="user_team_submit">Submit</button>
												</div>
										  </div>
...
$('.filtertabs>li>.nav-link').click(function(e) {
		...
		$('#user_team_submit').click(function(e) {
			var agent_array=[];
			var team_array=[];
			
			$('.useragentcheckbox').each(function(){
				if($(this).prop('checked')===true){
					agent_array.push($(this).data('id'));
				}
			});
			$('.userteamcheckbox').each(function(){
				if($(this).prop('checked')===true){
					team_array.push($(this).data('id'));
				}
			});
