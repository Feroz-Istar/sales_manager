...
%>
							...
							<div class="row align-items-center theme_solid_border_bottom m-0 pl-40 pr-40 pt-25 pb-25 ">
								<div class="col-md-2 col p-0">
									<div class="f-14 fw-500 black text-truncate d-inline" title="Team 01" data-toggle="tooltip" data-placement="bottom">Zencorporation Pot. Ltd.</div>
								...
								<div class="col-md-4 col-12 p-0">
									<div class="row m-0 align-items-center">
										<div class="col-md-11 p-0">
											<div class="row m-0">
												<img class="rounded-circle imgsize-40 mr-10" src="<%=baseURL%>assets/image/11.png" alt="Lead Image">
												<div class="col-md-10 p-0">
													...
													Pipeline">Pipeline - New Sales Pipeline</div>
												</div>
											</div>
										</div>
										<div class="col-md-1 p-0 text-right">
											<div class="dropdown dropleft d-inline">
												...
												<div class="dropdown-menu dropdown-menu-right istar-dropdown-menu arrow-left" style="margin-right: -5px !important; margin-top: -19px !important;" aria-labelledby="dropdownMenuButton">
													<button class="dropdown-item" onclick="openWonModal()">
														<div class="mr-2 dropdown-icon won"></div>
														Won
													</button>
													<button class="dropdown-item" onclick="openLostModal()">
														<div class="mr-2 dropdown-icon lost"></div>
														Lose
													</button>
